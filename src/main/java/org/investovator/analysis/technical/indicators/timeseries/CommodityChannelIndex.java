 ...
 * @version ${Revision}
 */
public class CommodityChannelIndex extends TimeSeriesIndicator {
    ...
    public ResultsSet calculate(Params parameters) throws InvalidParamException, AnalysisException {
        ...
        if(isParametersValid(timeSeriesParams)){
            try {
                ...
                Core core = new Core();
                RetCode retCode = core.cci(0, (closingPrices.length - 1),highPrices, lowPrices, closingPrices,
                ...
                if(retCode == RetCode.Success){
                    ...
                    resultSet.setGraph(TimeSeriesGraph.CCI, dates, out, begin.value, length.value);
                    return resultSet;
                } else {
