 ...
 * @version ${Revision}
 */
public class TestAROON extends TestIndicator {

    @Test
    public void testAROONCalculate() throws AnalysisException, ParseException, InvalidParamException {
        Calculator calculator = new CalculatorImpl();
        String staringDate = "1/4/2010";
        String endDate = "6/24/2010";
        ...
        TimeSeriesResultSet resultSet = (TimeSeriesResultSet) calculator.calculateValues(IndicatorType.AROON, params);
        ...
        assertTrue(resultSet.containsGraph(TimeSeriesGraph.AROON_DOWN));
        assertTrue(resultSet.containsGraph(TimeSeriesGraph.AROON_UP));

        String randomDate = "2/15/2010";
        assertEquals((resultSet.getGraph(TimeSeriesGraph.AROON_UP)).get(format.parse(randomDate)), 35.714285714285715);
        assertEquals((resultSet.getGraph(TimeSeriesGraph.AROON_DOWN)).get(format.parse(randomDate)), 100.0);
    }
}
