 ...
 * @version ${Revision}
 */
public class TestDX extends TestIndicator {

    @Test
    public void testDXCalculate() throws AnalysisException, ParseException, InvalidParamException {
        ...
        assertEquals((resultSet.getGraph(TimeSeriesGraph.DX)).get(format.parse(randomDate)), 7.4662598327942105);
    }
}
