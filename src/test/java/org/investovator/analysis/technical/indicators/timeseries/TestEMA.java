 ...
 * @version ${Revision}
 */
public class TestEMA extends TestIndicator {

    @Test
    public void testEMACalculate() throws AnalysisException, ParseException, InvalidParamException {
        ...
        assertTrue(resultSet.containsGraph(TimeSeriesGraph.EMA));

        String randomDate = "2/15/2010";
        assertEquals((resultSet.getGraph(TimeSeriesGraph.EMA)).get(format.parse(randomDate)), 217.03226167125055);
    }
}
